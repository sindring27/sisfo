    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="buttons.html">Nilai</a>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePages"
                ...
                <span>Info Yayasan</span>
            </a>
            <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Sub-Menu Yayasan</h6>
                    ...
                    <a class="collapse-item" href="forgot-password.html">Informasi Yayasan</a>
                    <a class="collapse-item" href="404.html">Tentang Yayasan</a>
                    <a class="collapse-item" href="blank.html">Fasilitas</a>
                    <a class="collapse-item" href="404.html">Materi Pelajaran</a>
        ...
        <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url('administrator/auth') ?>">
